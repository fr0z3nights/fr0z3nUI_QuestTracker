...
ns.rules = {
  ...
  hideIfAnyQuestInLog =     {85947, 86731,   85948, 83363,   85949, 83365,   86556, 83359,   86560, 93612,   86563, 93613,   86564, 93614,   888808, 88805,   92647, 92649,   93495, 93497},
  hideIfAnyQuestCompleted = {85947, 86731,   85948, 83363,   85949, 83365,   86556, 83359,   86560, 93612,   86563, 93613,   86564, 93614,   888808, 88805,   92647, 92649,   93495, 93497}, },


--  01  Classic              UPDATE REMINDER ABOVE & XRULESDB WHEN UPDATING LVL/MAX QUESTID
...
--  02  Outland             UPDATE REMINDER ABOVE & XRULESDB WHEN UPDATING LVL/MAX QUESTID
  ...
  indicators = { { questID = 40168, shape = "square", overlay = { itemIDs = { 9999999 }, text = "1", color = { 1.0, 1.0, 0.1 } }, }, }, },


--  03  Wrath               UPDATE REMINDER ABOVE & XRULESDB WHEN UPDATING LVL/MAX QUESTID
...
--  04  Cataclysm           UPDATE REMINDER ABOVE & XRULESDB WHEN UPDATING LVL/MAX QUESTID
...
--  05  Pandaria           UPDATE REMINDER ABOVE & XRULESDB WHEN UPDATING LVL/MAX QUESTID
...
--  06  Draenor            UPDATE REMINDER ABOVE & XRULESDB WHEN UPDATING LVL/MAX QUESTID
...
--  07  Legion            UPDATE REMINDER ABOVE & XRULESDB WHEN UPDATING LVL/MAX QUESTID
...
--  08  Battle             UPDATE REMINDER ABOVE & XRULESDB WHEN UPDATING LVL/MAX QUESTID
...
--  09  Shadowlands        UPDATE REMINDER ABOVE & XRULESDB WHEN UPDATING LVL/MAX QUESTID
...
--  10  Dragonflight        UPDATE REMINDER ABOVE  &  XRULESDB WHEN UPDATING LVL/MAX QUESTID  &  GET COPILOT TO ADD IT THE ADDON
  ...
  questInfo = "\194\160", fallbackQuestInLog = { 98125 }, preferQuestInfoForTitle = true, twKind = "dragonflight", hideWhenCompleted = false,
