...
ns.rules = {
  ...
  hideIfAnyQuestInLog =     {85947, 86731,   85948, 83363,   85949, 83365,   86556, 83359,   86560, 93612,   86563, 93613,   86564, 93614,   888808, 93627,   92647, 92649,   93495, 93497},
  hideIfAnyQuestCompleted = {85947, 86731,   85948, 83363,   85949, 83365,   86556, 83359,   86560, 93612,   86563, 93613,   86564, 93614,   888808, 93627,   92647, 92649,   93495, 93497}, },

--  01  Classic              UPDATE REMINDER ABOVE & XRULESDB & GOTALKEV WHEN UPDATING QUESTID
...
--  02  Outland             UPDATE REMINDER ABOVE & XRULESDB & GOTALKEV WHEN UPDATING QUESTID
...
--  03  Wrath               UPDATE REMINDER ABOVE & XRULESDB & GOTALKEV WHEN UPDATING QUESTID
...
--  04  Cataclysm           UPDATE REMINDER ABOVE & XRULESDB & GOTALKEV WHEN UPDATING QUESTID
...
--  05  Pandaria           UPDATE REMINDER ABOVE & XRULESDB & GOTALKEV WHEN UPDATING QUESTID
...
--  06  Draenor            UPDATE REMINDER ABOVE & XRULESDB & GOTALKEV WHEN UPDATING QUESTID
...
--  07  Legion            UPDATE REMINDER ABOVE & XRULESDB & GOTALKEV WHEN UPDATING QUESTID
...
--  08  Battle             UPDATE REMINDER ABOVE & XRULESDB & GOTALKEV WHEN UPDATING QUESTID
...
--  09  Shadowlands        UPDATE REMINDER ABOVE & XRULESDB & GOTALKEV WHEN UPDATING LVL/MAX QUESTID
...
--  10  Dragonflight        UPDATE REMINDER ABOVE & XRULESDB & GOTALKEV WHEN UPDATING LVL/MAX QUESTID
