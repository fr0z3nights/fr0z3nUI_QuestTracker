...
--  01  CLASSIC PROFESSIONS           If Not Clearing, Try Loading a Profession's Book After Learning                      /dump C_Map.GetBestMapForUnit("player")
  {label = "Classic Alchemy",         frameID = "list1", missingPrimaryProfessions = true, missingProfessionSkillLineID = 171,  textInfo = "Profession\n  - Alchemy", key = "XP01:Prof:Alchemy", },
  {label = "Classic Blacksmithing",   frameID = "list1", missingPrimaryProfessions = true, missingProfessionSkillLineID = 164,  textInfo = " - Blacksmithing",        key = "XP01:Prof:Blacksmithing", },
  {label = "Classic Cooking",         frameID = "list1",                                   missingProfessionSkillLineID = 185,  textInfo = " - Cooking",              key = "XP01:Prof:Cooking", },
  {label = "Classic Enchanting",      frameID = "list1", missingPrimaryProfessions = true, missingProfessionSkillLineID = 333,  textInfo = " - Enchanting",           key = "XP01:Prof:Enchanting", },
  {label = "Classic Engineering",     frameID = "list1", missingPrimaryProfessions = true, missingProfessionSkillLineID = 202,  textInfo = " - Engineering",          key = "XP01:Prof:Engineering", },
  {label = "Classic Fishing",         frameID = "list1",                                   missingProfessionSkillLineID = 356,  textInfo = " - Fishing",              key = "XP01:Prof:Fishing", },
  {label = "Classic Herbalism",       frameID = "list1", missingPrimaryProfessions = true, missingProfessionSkillLineID = 182,  textInfo = " - Herbalism",            key = "XP01:Prof:Herbalism", },
  {label = "Classic Inscription",     frameID = "list1", missingPrimaryProfessions = true, missingProfessionSkillLineID = 773,  textInfo = " - Inscription",          key = "XP01:Prof:Inscription", },
  {label = "Classic Jewelcrafting",   frameID = "list1", missingPrimaryProfessions = true, missingProfessionSkillLineID = 755,  textInfo = " - Jewelcrafting",        key = "XP01:Prof:Jewelcrafting", },
  {label = "Classic Leatherworking",  frameID = "list1", missingPrimaryProfessions = true, missingProfessionSkillLineID = 165,  textInfo = " - Leatherworking",       key = "XP01:Prof:Leatherworking", },
  {label = "Classic Mining",          frameID = "list1", missingPrimaryProfessions = true, missingProfessionSkillLineID = 186,  textInfo = " - Mining",               key = "XP01:Prof:Mining", },
  {label = "Classic Skinning",        frameID = "list1", missingPrimaryProfessions = true, missingProfessionSkillLineID = 393,  textInfo = " - Skinning",             key = "XP01:Prof:Skinning", },
  {label = "Classic Tailoring",       frameID = "list1", missingPrimaryProfessions = true, missingProfessionSkillLineID = 197,  textInfo = " - Tailoring\n ",         key = "XP01:Prof:Tailoring", },
