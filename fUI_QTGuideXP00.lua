...
--  Guild Cloaks
  {key = "XP04:GuildCloak1A", faction = "A",                      label = "Guild Cloak A1",          frameID = "bar1",    mapID = {"STW"},    textInfo = "|cff1eff00Guild Cloak|r",   showIf = { factionID = 1168, minStanding = 6 },                                                              complete = { any = { { itemIDs = { 63352 }, includeBank = true }, }, }, },
  {key = "XP04:GuildCloak2A", faction = "A",                      label = "Guild Cloak A2",          frameID = "bar1",    mapID = {"STW"},    textInfo = "|cff0070ddGuild Cloak|r",   showIf = { all = { { factionID = 1168, minStanding = 7 }, { itemIDs = { 63352 }, includeBank = true }, }, }, complete = { any = { { itemIDs = { 63206 }, includeBank = true }, }, }, },
  {key = "XP04:GuildCloak3A", faction = "A",                      label = "Guild Cloak A3",          frameID = "bar1",    mapID = {"STW"},    textInfo = "|cffa335eeGuild Cloak|r",   showIf = { all = { { factionID = 1168, minStanding = 8 }, { itemIDs = { 63206 }, includeBank = true }, }, }, complete = { any = { { itemIDs = { 65360 }, includeBank = true }, }, }, },
  {key = "XP04:GuildCloak1H", faction = "H",                      label = "Guild Cloak H1",          frameID = "bar1",    mapID = {"ORG"},    textInfo = "|cff1eff00Guild Cloak|r",   showIf = { factionID = 1168, minStanding = 6 },                                                              complete = { any = { { itemIDs = { 63353 }, includeBank = true }, }, }, },
  {key = "XP04:GuildCloak2H", faction = "H",                      label = "Guild Cloak H2",          frameID = "bar1",    mapID = {"ORG"},    textInfo = "|cff0070ddGuild Cloak|r",   showIf = { all = { { factionID = 1168, minStanding = 7 }, { itemIDs = { 63353 }, includeBank = true }, }, }, complete = { any = { { itemIDs = { 63207 }, includeBank = true }, }, }, },
  {key = "XP04:GuildCloak3H", faction = "H",                      label = "Guild Cloak H3",          frameID = "bar1",    mapID = {"ORG"},    textInfo = "|cffa335eeGuild Cloak|r",   showIf = { all = { { factionID = 1168, minStanding = 8 }, { itemIDs = { 63207 }, includeBank = true }, }, }, complete = { any = { { itemIDs = { 65274 }, includeBank = true }, }, }, },
--  Phazed Zones (Try)
  {key = "XP06:PZBlasted",    questID = 66560,                    label = "Blasted Phaze WoD",       frameID = "bar1",   mapID = 17,          questInfo = "|cffa335eeWARLORDS PHAZED|r", },
  {key = "XP08:PZSilithus",   questID = 50659,                    label = "Silithus Phaze BFA",      frameID = "bar1",   mapID = 81,          questInfo = "|cffa335eeBATTLE PHAZED|r", },
  {key = "XP08:PZArathi",     questID = 50659,                    label = "Arathi Phaze BFA",        frameID = "bar1",   mapID = 14,          questInfo = "|cffa335eeBATTLE PHAZED|r", },
  {key = "XP08:PZTirisfal",   questID = 52758,                    label = "Tirisfal Phaze BFA",      frameID = "bar1",   mapID = {18,2070},   questInfo = "|cffa335eeBATTLE PHAZED|r", },
  {key = "XP08:PZDarkshore",  questID = 52758,                    label = "Darkshore Phaze BFA",     frameID = "bar1",   mapID = 62,          questInfo = "|cffa335eeBATTLE PHAZED|r", },
