...
--  12   MIDNIGHT PROFESSIONS         If Not Clearing, Try Loading a Profession's Book After Learning                      /dump C_Map.GetBestMapForUnit("player")
	...
	{key = "XP12:PFindFish",						profSID = 356,		label = "Midnight Find Fish",      frameID = "list1",                       itemInfo = "Midnight Fish Finder\n - Silvermoon 45,60\n - Buy Angler's Guide", rested = true, missingFindFish = true, showIf = { missingFindFish = true }, item = { itemID = 228954, inBank = true, required = { 1, Y, Y, 1 }, cachePurchased = Y, cachePurchasedFromBag = N, knownTooltip = Y, }, complete = {any = { {item = { itemID = 228954, count = 1, cachePurchased = Y, cachePurchasedFromBag = N } }, { hasFindFish = true } }, }, },
...
--  09   SHADOWLANDS PROFESSIONS      If Not Clearing, Try Loading a Profession's Book After Learning                      /dump C_Map.GetBestMapForUnit("player")
	...
	{key = "XP09:PFishingRod",											label = "Shadow Fishing Rod",      frameID = "list1",	mapID = {"SHD"},	itemInfo = " - Buy Brokers Angle'r", item = { itemID = 180136, inBank = true, required = { 1, Y, Y, 1 }, }, complete = {any = { {item = { itemID = 180136, count = 1} }, }, }, },
...
--  Guild Cloaks
	{key = "XP01:I6948",    	item = { itemID =   6948, mustHave = true, showCount = false, },		label = "BankIt 6948",		  frameID = "list2",	resting = true, itemInfo = "Hearthstone\n + Deposit in Bank" },
	{key = "XP04:GuildCloak1A",	faction = "A",							label = "Guild Cloak A1",          frameID = "list2",	mapID = {"STW"},	itemInfo = "GUILD CLOAK",			size = 22, color = "1eff00", align = "center", showIf = { factionID = 1168, minStanding = 6 },                                                              item = { itemID = 63352, inBank = true, required = { 1, Y, Y, 1 }, showCount = false, }, complete = { any = { { itemIDs = { 63352 }, includeBank = true }, }, }, },
	{key = "XP04:GuildCloak2A", faction = "A",							label = "Guild Cloak A2",          frameID = "list2",	mapID = {"STW"},	itemInfo = "GUILD CLOAK",			size = 22, color = "0070dd", align = "center", showIf = { all = { { factionID = 1168, minStanding = 7 }, { itemIDs = { 63352 }, includeBank = true }, }, }, item = { itemID = 63206, inBank = true, required = { 1, Y, Y, 1 }, showCount = false, }, complete = { any = { { itemIDs = { 63206 }, includeBank = true }, }, }, },
	{key = "XP04:GuildCloak3A", faction = "A",							label = "Guild Cloak A3",          frameID = "list2",	mapID = {"STW"},	itemInfo = "GUILD CLOAK",			size = 22, color = "a335ee", align = "center", showIf = { all = { { factionID = 1168, minStanding = 8 }, { itemIDs = { 63206 }, includeBank = true }, }, }, item = { itemID = 65360, inBank = true, required = { 1, Y, Y, 1 }, showCount = false, }, complete = { any = { { itemIDs = { 65360 }, includeBank = true }, }, }, },
	{key = "XP04:GuildCloak1H", faction = "H",							label = "Guild Cloak H1",          frameID = "list2",	mapID = {"ORG"},	itemInfo = "GUILD CLOAK",			size = 22, color = "1eff00", align = "center", showIf = { factionID = 1168, minStanding = 6 },                                                              item = { itemID = 63353, inBank = true, required = { 1, Y, Y, 1 }, showCount = false, }, complete = { any = { { itemIDs = { 63353 }, includeBank = true }, }, }, },
	{key = "XP04:GuildCloak2H", faction = "H",							label = "Guild Cloak H2",          frameID = "list2",	mapID = {"ORG"},	itemInfo = "GUILD CLOAK",			size = 22, color = "0070dd", align = "center", showIf = { all = { { factionID = 1168, minStanding = 7 }, { itemIDs = { 63353 }, includeBank = true }, }, }, item = { itemID = 63207, inBank = true, required = { 1, Y, Y, 1 }, showCount = false, }, complete = { any = { { itemIDs = { 63207 }, includeBank = true }, }, }, },
	{key = "XP04:GuildCloak3H", faction = "H",							label = "Guild Cloak H3",          frameID = "list2",	mapID = {"ORG"},	itemInfo = "GUILD CLOAK",			size = 22, color = "a335ee", align = "center", showIf = { all = { { factionID = 1168, minStanding = 8 }, { itemIDs = { 63207 }, includeBank = true }, }, }, item = { itemID = 65274, inBank = true, required = { 1, Y, Y, 1 }, showCount = false, }, complete = { any = { { itemIDs = { 65274 }, includeBank = true }, }, }, },
	{key = "Blingtron", 		questID = 56042, 	hideDone = true, 	label = "Blingtron", 				frameID = "list2", 						questInfo = "B L I N G T R O N",	size = 22, color = "ffe633", align = "center",  },
--  Phazed Zones (Try)
