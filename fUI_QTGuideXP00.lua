...
--  08   BATTLE PROFESSIONS           If Not Clearing, Try Loading a Profession's Book After Learning                      /dump C_Map.GetBestMapForUnit("player")
  {label = "Battle Archaeology",      frameID = "list1",                              missingProfessionSkillLineID = 794,  locationID = {1161, 1163,},  textInfo = "Battle Archaeology",      key = "XP08:Prof:Archaeology", },
  {label = "Battle Alchemy",          frameID = "list1", professionSkillLineID = 171, missingProfessionSkillLineID = 2478, locationID = {1161, 1163,},  textInfo = "Battle Alchemy",          key = "XP08:Prof:Alchemy", },
  {label = "Battle Blacksmithing",    frameID = "list1", professionSkillLineID = 164, missingProfessionSkillLineID = 2437, locationID = {1161, 1163,},  textInfo = "Battle Blacksmithing",    key = "XP08:Prof:Blacksmithing", },
  {label = "Battle Enchanting",       frameID = "list1", professionSkillLineID = 333, missingProfessionSkillLineID = 2486, locationID = {1161, 1163,},  textInfo = "Battle Enchanting",       key = "XP08:Prof:Enchanting", },
  {label = "Battle Engineering",      frameID = "list1", professionSkillLineID = 202, missingProfessionSkillLineID = 2499, locationID = {1161, 1163,},  textInfo = "Battle Engineering",      key = "XP08:Prof:Engineering", },
  {label = "Battle Herbalism",        frameID = "list1", professionSkillLineID = 182, missingProfessionSkillLineID = 2549, locationID = {1161, 1163,},  textInfo = "Battle Herbalism",        key = "XP08:Prof:Herbalism", },
  {label = "Battle Inscription",      frameID = "list1", professionSkillLineID = 773, missingProfessionSkillLineID = 2508, locationID = {1161, 1163,},  textInfo = "Battle Inscription",      key = "XP08:Prof:Inscription", },
  {label = "Battle Jewelcrafting",    frameID = "list1", professionSkillLineID = 755, missingProfessionSkillLineID = 2518, locationID = {1161, 1163,},  textInfo = "Battle Jewelcrafting",    key = "XP08:Prof:Jewelcrafting", },
  {label = "Battle Leatherworking",   frameID = "list1", professionSkillLineID = 165, missingProfessionSkillLineID = 2525, locationID = {1161, 1163,},  textInfo = "Battle Leatherworking",   key = "XP08:Prof:Leatherworking", },
  {label = "Battle Mining",           frameID = "list1", professionSkillLineID = 186, missingProfessionSkillLineID = 2565, locationID = {1161, 1163,},  textInfo = "Battle Mining",           key = "XP08:Prof:Mining", },
  {label = "Battle Skinning",         frameID = "list1", professionSkillLineID = 393, missingProfessionSkillLineID = 2557, locationID = {1161, 1163,},  textInfo = "Battle Skinning",         key = "XP08:Prof:Skinning", },
  {label = "Battle Tailoring",        frameID = "list1", professionSkillLineID = 197, missingProfessionSkillLineID = 2533, locationID = {1161, 1163,},  textInfo = "Battle Tailoring",        key = "XP08:Prof:Tailoring", },
  {label = "Battle Cooking",          frameID = "list1", professionSkillLineID = 185, missingProfessionSkillLineID = 2541, locationID = {1161, 1163,},  textInfo = "Battle Cooking\n - Open Profession After", key = "XP08:Prof:Cooking", },
  {label = "Battle Fishing",          frameID = "list1", professionSkillLineID = 356, missingProfessionSkillLineID = 2585, locationID = {1161, 1163,},  textInfo = "Battle Fishing",          key = "XP08:Prof:Fishing", },
