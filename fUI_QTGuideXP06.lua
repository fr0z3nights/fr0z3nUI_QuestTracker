...
local bakedRules = {
  ...
  {key = "XP06:Q36615A",  questID = 36615,                     label = "06 A Garrison 4", frameID = "list2", hideDone = true, faction = "A",                                      questInfo = "Level Garrison to 3", restedOnly = true, },
--                                                                                                                                       -- mapIDs: fUI_QTUsage.lua
  ...
  {key = "XP06:Q36614H",  questID = 36614,                     label = "06 H Garrison 5", frameID = "list2", hideDone = true, faction = "H",                                      questInfo = "Level Garrison to 3", restedOnly = true, },
