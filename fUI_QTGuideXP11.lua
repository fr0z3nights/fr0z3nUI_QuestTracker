...
--                                                                                                                                       -- mapIDs: fUI_QTUsage.lua
  {key = "XP11:I230728",  item = {itemID = 230728, required = { 5, true, N, 0 },},  label = "Experimental Go-Pack",   hideDone = false,  mapID = {2369,},                             frameID = "list1",  itemInfo = "Experimental Go-Pack", },
  {key = "XP11:I202046",  item = {itemID = 202046, required = { 1, true, N, 0 },},  label = "Lucky Tortollan Charm",  restedOnly = true, mapID = {"CAP","TWW"},                       frameID = "list1",  itemInfo = "Lucky Tortollan Charm\n - Near Azj-Kahet Portal", },
...
--{key = "XP11:Q82434",   questID = 82434, prereq = { 46931, 51341, 61874, },       label = "Coffer Key 82434",       hideDone = true,                                                frameID = "list1",  questInfo = " + Key - Spiders (Portal)", },
  ...
  {key = "XP11:Q84260",   questID = 84260, prereq = { 46957, 51341, 61874, },       label = "Crafting Order",         hideDone = true,   mapID = {"TWW"},                             frameID = "list1",  questInfo = "+ Dornogal Crafting Order Reward", },
