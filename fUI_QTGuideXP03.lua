...
{label = "Kirin Tor Ring",            frameID = "list1", key = "XP03:Port:KirinTor",      playerLevel = { ">", 80, }, mapID = {84,85,125,}, gold = 10000, complete = { any = { { itemIDs = {40586,44935,40585,44934,45688,45690,45691,45689,48954,48955,48956,48957,51557,51558,51559,51560,}, includeBank = true }, }, },  itemInfo = "Kirin Tor Ring\n + 8500 |TInterface\\MoneyFrame\\UI-GoldIcon:16:16:0:0|t",  },
